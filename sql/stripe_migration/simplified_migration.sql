-- Version ultra simplifiée de la migration Stripe

-- Créer la fonction set_updated_at si nécessaire (sans bloc DO)
...
-- Fonction pour vérifier le compte Stripe d'un prestataire
